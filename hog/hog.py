...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    increment=abs(opponent_score//10%10-player_score%10)*3
    if increment==0 :
        increment=1
    return increment
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    default_score=strategy(0,0)
    for i in range(0,goal):
        for j in range(0,goal):
            if strategy(i,j)!=default_score:
                return False
    return True
    # END PROBLEM 7
...
def boar_strategy(score, opponent_score, threshold=10, num_rolls=6):
...
def sus_strategy(score, opponent_score, threshold=10, num_rolls=6):
